...
export default function FeatureBox({ mode, setmode }) {
    ...
    var handelImageInput = (e) => {
        ...
        if (file) {
            ...
            render.onload = () => {
                ...
                setmode({...mode , image: render.result})
            }
    ...
    var features = [{
        ...
        clickFunc: () => {
            setmode({ ...mode, mode: "select_pointer" })
        }
    }
        , {
        ...
        Children: [{
            ...
            clickFunc: () => {
                setmode({ mode: "pen", propertice: { ...mode.propertice } })
            }
        }, {
            name: "highlighter",
            label: "Highlited Pen",
            ...
            clickFunc: () => {
                setmode({ mode: "highlighter", propertice: { ...mode.propertice } })
            }
        }],
    }, {
        name: "color-select",
        ...
        name: "eraser",
        label: "Eraser",
        icon: (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" color={mode.mode === "eraser" ? "red" : ""} fill="currentColor" class="bi bi-eraser-fill" viewBox="0 0 16 16">
            <path d="M8.086 2.207a2 2 0 0 1 2.828 0l3.879 3.879a2 2 0 0 1 0 2.828l-5.5 5.5A2 2 0 0 1 7.879 15H5.12a2 2 0 0 1-1.414-.586l-2.5-2.5a2 2 0 0 1 0-2.828zm.66 11.34L3.453 8.254 1.914 9.793a1 1 0 0 0 0 1.414l2.5 2.5a1 1 0 0 0 .707.293H7.88a1 1 0 0 0 .707-.293z" />
        </svg>),
        clickFunc: () => {
            setmode({ ...mode, mode: "eraser" })
        }
    }, {
    ...
    },
    {
        ...
        Children: [{
            name: "selecImageInput",
            label: "Select Image File",
            icon: (<>
                <div>
                    <input type="file" name="" id="" onChange={handelImageInput} />
                    {/* <image  src={} /> */}
                </div></>)
        }],
        clickFunc: ()=>{
            setmode({...mode , mode: "image"})
        }
    }
    ]

    const [iamgevalue, setiamgevalue] = useState("")
    return (
        <div id='feature-div'>
